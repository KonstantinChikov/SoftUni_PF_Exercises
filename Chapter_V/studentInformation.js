// Ex. II --> You will be given 3 parameters – student name (string), age (number), 
// and average grade (number). Your task is to print all the info about the student in the following format:
